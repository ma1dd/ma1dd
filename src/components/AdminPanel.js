...
const AdminPanel = () => {
  ...
  const availableRoles = ['аналитик', 'менеджер по продукту', 'маркетолог', 'руководитель отдела', 'администратор'];
            ...
            <form onSubmit={editingUser ? handleUpdateUser : handleAddUser}>
              ...
              <div className="form-row">
                <div className="form-group">
                  ...
                  <input
                    ...
                    onChange={(e) => setFormData({ ...formData, логин: e.target.value })}
                    required
                  />
                </div>
                <div className="form-group">
                ...
                <div className="form-group">
                  ...
                  <input
                    ...
                    onChange={(e) => setFormData({ ...formData, пароль: e.target.value })}
                    required
                  />
                </div>
              </div>
              ...
              <div className="form-row">
                <div className="form-group">
                  ...
                  <select
                    value={formData.роль}
                    onChange={(e) => setFormData({ ...formData, роль: e.target.value })}
                    required
                  >
          ...
          {users.length > 0 ? (
            users.map(user => (
              <div key={user.id} className="table-row">
                ...
                <div className="table-cell table-cell-phone">{user.телефон || '-'}</div>
