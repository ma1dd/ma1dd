...
const Products = () => {
  ...
  const handleLoadMore = () => {
    ...
    const nextProducts = filteredProducts.slice(currentCount, currentCount + itemsPerPage);
        ...
        {displayedProducts.length > 0 ? (
          displayedProducts.map(product => {
            const positivePercent = product.статистика_отзывов.всего_отзывов > 0 
              ...
              : 0;
            const salesPerMonth = Math.floor(product.статистика_отзывов.всего_отзывов * 0.7); // Примерная оценка продаж
              ...
              >
                ...
                <div className="product-stats">
                  ...
                  <div className="product-stat">
                    ...
                    <span className={`stat-value ${ratingClass || 'stat-positive'}`}>{product.статистика_отзывов.средний_рейтинг.toFixed(1)}/5</span>
                  </div>
                  <div className="product-stat">
